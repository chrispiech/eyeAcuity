...
'''
class BATPrecision(BayesianAcuityTest):
	...
	def isDone(self):
		...
		if self.n <= MINIMUM_N: return False
		if self.n >= MAXIMUM_N: return True

		ans, confidence = self.getBestAnswerSoFar()
		# print(self.n, confidence)
		return confidence >= CONFIDENCE_GOAL
