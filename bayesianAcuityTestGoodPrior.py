...
class BayesianAcuityGoodPrior:
	...
	def __init__(self, nQuestions, priorK1):
		self.n = 0
		self.nQuestions = nQuestions
		self.results = []
		self.priorK1 = priorK1
	...
	def getParamSamples(self):
		samples = []
		actualPrior = self.nearestLine(self.priorK1)
		mu = math.log(actualPrior, 10)
		print(self.priorK1, actualPrior)
		for i in range(N_SAMPLES):
			
			logK1 = self.rejectSampleGumbel(mu, 0.05, MIN_LOG_MAR, MAX_LOG_MAR)
